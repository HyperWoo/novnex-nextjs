                ...
                <div className="col-lg-8">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <span className="mil-suptitle mil-light mil-upper mil-up mil-mb-30">Noida, Uttar Pradesh</span>
                            <p className="mil-text-sm mil-up mil-light-soft mil-mb-30">5th Floor, Tower-C, <br/>Green Boulevard, Sector 62 <br/>Noida, UP 201309 <br/>(+91) 123-4567-890</p>
                        </div>
                        {/* <div className="col-md-6 col-lg-6 col-xl-3">
